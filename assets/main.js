...
function removeElementsByClass(className){
  ...
  function loadFile() {
      ...
      function receivedText(e) {
        ...
        var newArr = JSON.parse(lines); //newArr will be an array of objects, each object is a row from the excel doc
        let arrayOfMarkers = Object.keys(newArr[0]);//used as an array of markers to reference if a droput match occurs or a no data match
